...
extension Notification.Name {
    ...
    static let IAPHelperTransactionIdentifierNotification = Notification.Name("IAPHelperTransactionIdentifierNotification")
...
extension IAPHelper {
    ...
    func buyProduct(_ id: String) {
        let filtered = products.filter { $0.productIdentifier == id }
        guard let product = filtered.first else {
            return
        }
...
extension IAPHelper: SKPaymentTransactionObserver {
    ...
    private func deliverTransactionNotification(identifier: String?) {
        guard let identifier = identifier else { return }
        NotificationCenter.default.post(name: .IAPHelperPurchaseNotification, object: identifier)
    }
